...
export default function SelectLanguagePage() {
  ...
  return (
    <>
      <div id="page-body">
        ...
        <div className="form">
          <div className="languageSwitch-form">
            <button
              className={`rectangleBox ${selectedLanguage === 'ko' ? 'active' : ''}`}
              onClick={() => handleButtonClick('ko')}
            >
              한국어
            </button>
            <button
              className={`rectangleBox ${selectedLanguage === 'en' ? 'active' : ''}`}
          ...
          <div className="agreement_form">
            ...
            <div className="agreement_set">
              ...
              <label className="privacy-text" htmlFor="terms-privacy">
      ...
      <Footer buttonText="다음" onClick={handleFooterButtonClick} isFormComplete={isFormComplete} />
    </>
  );
}
